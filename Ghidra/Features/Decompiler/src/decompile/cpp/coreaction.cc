...

{
  ...
  act = make_unique<ActionRestartGroup>(Action::rule_onceperfunc,"universal",1).release();
  registerAction(universalname,act);

  act->addAction(make_unique<ActionStart>("base").release());
  act->addAction(make_unique<ActionConstbase>("base").release());
  act->addAction(make_unique<ActionNormalizeSetup>("normalanalysis").release());
  act->addAction(make_unique<ActionDefaultParams>("base").release());
  //  act->addAction(make_unique<ActionParamShiftStart>("paramshift").release());
  act->addAction(make_unique<ActionExtraPopSetup>("base",stackspace).release());
  act->addAction(make_unique<ActionPrototypeTypes>("protorecovery").release());
  act->addAction(make_unique<ActionFuncLink>("protorecovery").release());
  act->addAction(make_unique<ActionFuncLinkOutOnly>("noproto").release());
  {
    actfullloop = make_unique<ActionGroup>(Action::rule_repeatapply,"fullloop").release();
    {
      actmainloop = make_unique<ActionGroup>(Action::rule_repeatapply,"mainloop").release();
      actmainloop->addAction(make_unique<ActionUnreachable>("base").release());
      actmainloop->addAction(make_unique<ActionVarnodeProps>("base").release());
      actmainloop->addAction(make_unique<ActionHeritage>("base").release());
      actmainloop->addAction(make_unique<ActionParamDouble>("protorecovery").release());
      actmainloop->addAction(make_unique<ActionSegmentize>("base").release());
      actmainloop->addAction(make_unique<ActionInternalStorage>("base").release());
      actmainloop->addAction(make_unique<ActionForceGoto>("blockrecovery").release());
      actmainloop->addAction(make_unique<ActionDirectWrite>("protorecovery_a", true).release());
      actmainloop->addAction(make_unique<ActionDirectWrite>("protorecovery_b", false).release());
      actmainloop->addAction(make_unique<ActionActiveParam>("protorecovery").release());
      actmainloop->addAction(make_unique<ActionReturnRecovery>("protorecovery").release());
      //      actmainloop->addAction(make_unique<ActionParamShiftStop>("paramshift").release());
      actmainloop->addAction(make_unique<ActionRestrictLocal>("localrecovery").release()); // Do before dead code removed
      actmainloop->addAction(make_unique<ActionDeadCode>("deadcode").release());
      actmainloop->addAction(make_unique<ActionDynamicMapping>("dynamic").release()); // Must come before restructurevarnode and infertypes
      actmainloop->addAction(make_unique<ActionSpacebase>("base").release());	// Must come before infertypes and nonzeromask
      actmainloop->addAction(make_unique<ActionNonzeroMask>("analysis").release());
      actmainloop->addAction(make_unique<ActionInferTypes>("typerecovery").release());
      actmainloop->addAction(make_unique<ActionRestructureVarnode>("localrecovery").release());
	...
	actprop->addRule(make_unique<RuleCollectTerms>("analysis").release());
	actprop->addRule(make_unique<RulePullsubMulti>("analysis").release());
	actprop->addRule(make_unique<RulePullsubIndirect>("analysis").release());
	actprop->addRule(make_unique<RulePushMulti>("nodejoin").release());
	actprop->addRule(make_unique<RuleSborrow>("analysis").release());
	actprop->addRule(make_unique<RuleScarry>("analysis").release());
	actprop->addRule(make_unique<RuleIntLessEqual>("analysis").release());
	actprop->addRule(make_unique<RuleTrivialArith>("analysis").release());
	actprop->addRule(make_unique<RuleTrivialBool>("analysis").release());
	actprop->addRule(make_unique<RuleTrivialShift>("analysis").release());
	actprop->addRule(make_unique<RuleSignShift>("analysis").release());
	actprop->addRule(make_unique<RuleTestSign>("analysis").release());
	actprop->addRule(make_unique<RuleIdentityEl>("analysis").release());
	actprop->addRule(make_unique<RuleOrMask>("analysis").release());
	actprop->addRule(make_unique<RuleAndMask>("analysis").release());
	actprop->addRule(make_unique<RuleOrConsume>("analysis").release());
	actprop->addRule(make_unique<RuleOrCollapse>("analysis").release());
	actprop->addRule(make_unique<RuleAndOrLump>("analysis").release());
	actprop->addRule(make_unique<RuleShiftBitops>("analysis").release());
	actprop->addRule(make_unique<RuleRightShiftAnd>("analysis").release());
	actprop->addRule(make_unique<RuleNotDistribute>("analysis").release());
	actprop->addRule(make_unique<RuleHighOrderAnd>("analysis").release());
	actprop->addRule(make_unique<RuleAndDistribute>("analysis").release());
	actprop->addRule(make_unique<RuleAndCommute>("analysis").release());
	actprop->addRule(make_unique<RuleAndPiece>("analysis").release());
	actprop->addRule(make_unique<RuleAndZext>("analysis").release());
	actprop->addRule(make_unique<RuleAndCompare>("analysis").release());
	actprop->addRule(make_unique<RuleDoubleSub>("analysis").release());
	actprop->addRule(make_unique<RuleDoubleShift>("analysis").release());
	actprop->addRule(make_unique<RuleDoubleArithShift>("analysis").release());
	actprop->addRule(make_unique<RuleConcatShift>("analysis").release());
	actprop->addRule(make_unique<RuleLeftRight>("analysis").release());
	actprop->addRule(make_unique<RuleShiftCompare>("analysis").release());
	actprop->addRule(make_unique<RuleShift2Mult>("analysis").release());
	actprop->addRule(make_unique<RuleShiftPiece>("analysis").release());
	actprop->addRule(make_unique<RuleMultiCollapse>("analysis").release());
	actprop->addRule(make_unique<RuleIndirectCollapse>("analysis").release());
	actprop->addRule(make_unique<Rule2Comp2Mult>("analysis").release());
	actprop->addRule(make_unique<RuleSub2Add>("analysis").release());
	actprop->addRule(make_unique<RuleCarryElim>("analysis").release());
	actprop->addRule(make_unique<RuleBxor2NotEqual>("analysis").release());
	actprop->addRule(make_unique<RuleLess2Zero>("analysis").release());
	actprop->addRule(make_unique<RuleLessEqual2Zero>("analysis").release());
	actprop->addRule(make_unique<RuleSLess2Zero>("analysis").release());
	actprop->addRule(make_unique<RuleEqual2Zero>("analysis").release());
	actprop->addRule(make_unique<RuleEqual2Constant>("analysis").release());
	actprop->addRule(make_unique<RuleThreeWayCompare>("analysis").release());
	actprop->addRule(make_unique<RuleXorCollapse>("analysis").release());
	actprop->addRule(make_unique<RuleAddMultCollapse>("analysis").release());
	actprop->addRule(make_unique<RuleCollapseConstants>("analysis").release());
	actprop->addRule(make_unique<RuleTransformCpool>("analysis").release());
	actprop->addRule(make_unique<RulePropagateCopy>("analysis").release());
	actprop->addRule(make_unique<RuleZextEliminate>("analysis").release());
	actprop->addRule(make_unique<RuleSlessToLess>("analysis").release());
	actprop->addRule(make_unique<RuleZextSless>("analysis").release());
	actprop->addRule(make_unique<RuleBitUndistribute>("analysis").release());
	actprop->addRule(make_unique<RuleBooleanUndistribute>("analysis").release());
	actprop->addRule(make_unique<RuleBooleanDedup>("analysis").release());
	actprop->addRule(make_unique<RuleBoolZext>("analysis").release());
	actprop->addRule(make_unique<RuleBooleanNegate>("analysis").release());
	actprop->addRule(make_unique<RuleLogic2Bool>("analysis").release());
	actprop->addRule(make_unique<RuleSubExtComm>("analysis").release());
	actprop->addRule(make_unique<RuleSubCommute>("analysis").release());
	actprop->addRule(make_unique<RuleConcatCommute>("analysis").release());
	actprop->addRule(make_unique<RuleConcatZext>("analysis").release());
	actprop->addRule(make_unique<RuleZextCommute>("analysis").release());
	actprop->addRule(make_unique<RuleZextShiftZext>("analysis").release());
	actprop->addRule(make_unique<RuleShiftAnd>("analysis").release());
	actprop->addRule(make_unique<RuleConcatZero>("analysis").release());
	actprop->addRule(make_unique<RuleConcatLeftShift>("analysis").release());
	actprop->addRule(make_unique<RuleSubZext>("analysis").release());
	actprop->addRule(make_unique<RuleSubCancel>("analysis").release());
	actprop->addRule(make_unique<RuleShiftSub>("analysis").release());
	actprop->addRule(make_unique<RuleHumptyDumpty>("analysis").release());
	actprop->addRule(make_unique<RuleDumptyHump>("analysis").release());
	actprop->addRule(make_unique<RuleHumptyOr>("analysis").release());
	actprop->addRule(make_unique<RuleNegateIdentity>("analysis").release());
	actprop->addRule(make_unique<RuleSubNormal>("analysis").release());
	actprop->addRule(make_unique<RulePositiveDiv>("analysis").release());
	actprop->addRule(make_unique<RuleDivTermAdd>("analysis").release());
	actprop->addRule(make_unique<RuleDivTermAdd2>("analysis").release());
	actprop->addRule(make_unique<RuleDivOpt>("analysis").release());
	actprop->addRule(make_unique<RuleSignForm>("analysis").release());
	actprop->addRule(make_unique<RuleSignForm2>("analysis").release());
	actprop->addRule(make_unique<RuleSignDiv2>("analysis").release());
	actprop->addRule(make_unique<RuleDivChain>("analysis").release());
	actprop->addRule(make_unique<RuleSignNearMult>("analysis").release());
	actprop->addRule(make_unique<RuleModOpt>("analysis").release());
	actprop->addRule(make_unique<RuleSignMod2nOpt>("analysis").release());
	actprop->addRule(make_unique<RuleSignMod2nOpt2>("analysis").release());
	actprop->addRule(make_unique<RuleSignMod2Opt>("analysis").release());
	actprop->addRule(make_unique<RuleSwitchSingle>("analysis").release());
	actprop->addRule(make_unique<RuleCondNegate>("analysis").release());
	actprop->addRule(make_unique<RuleBoolNegate>("analysis").release());
	actprop->addRule(make_unique<RuleLessEqual>("analysis").release());
	actprop->addRule(make_unique<RuleLessNotEqual>("analysis").release());
	actprop->addRule(make_unique<RuleLessOne>("analysis").release());
	actprop->addRule(make_unique<RuleRangeMeld>("analysis").release());
	actprop->addRule(make_unique<RuleFloatRange>("analysis").release());
	actprop->addRule(make_unique<RulePiece2Zext>("analysis").release());
	actprop->addRule(make_unique<RulePiece2Sext>("analysis").release());
	actprop->addRule(make_unique<RulePopcountBoolXor>("analysis").release());
	actprop->addRule(make_unique<RuleXorSwap>("analysis").release());
	actprop->addRule(make_unique<RuleLzcountShiftBool>("analysis").release());
	actprop->addRule(make_unique<RuleFloatSign>("analysis").release());
	actprop->addRule(make_unique<RuleOrCompare>("analysis").release());
	actprop->addRule(make_unique<RuleSubvarAnd>("subvar").release());
	actprop->addRule(make_unique<RuleSubvarSubpiece>("subvar").release());
	actprop->addRule(make_unique<RuleSplitFlow>("subvar").release());
	actprop->addRule(make_unique<RulePtrFlow>("subvar",conf).release());
	actprop->addRule(make_unique<RuleSubvarCompZero>("subvar").release());
	actprop->addRule(make_unique<RuleSubvarShift>("subvar").release());
	actprop->addRule(make_unique<RuleSubvarZext>("subvar").release());
	actprop->addRule(make_unique<RuleSubvarSext>("subvar").release());
	actprop->addRule(make_unique<RuleNegateNegate>("analysis").release());
	actprop->addRule(make_unique<RuleConditionalMove>("conditionalexe").release());
	actprop->addRule(make_unique<RuleOrPredicate>("conditionalexe").release());
	actprop->addRule(make_unique<RuleFuncPtrEncoding>("analysis").release());
	actprop->addRule(make_unique<RuleSubfloatConvert>("floatprecision").release());
	actprop->addRule(make_unique<RuleFloatCast>("floatprecision").release());
	actprop->addRule(make_unique<RuleIgnoreNan>("floatprecision").release());
	actprop->addRule(make_unique<RuleUnsigned2Float>("analysis").release());
	actprop->addRule(make_unique<RuleInt2FloatCollapse>("analysis").release());
	actprop->addRule(make_unique<RulePtraddUndo>("typerecovery").release());
	actprop->addRule(make_unique<RulePtrsubUndo>("typerecovery").release());
	actprop->addRule(make_unique<RuleSegment>("segment").release());
	actprop->addRule(make_unique<RulePiecePathology>("protorecovery").release());

	actprop->addRule(make_unique<RuleDoubleLoad>("doubleload").release());
	actprop->addRule(make_unique<RuleDoubleStore>("doubleprecis").release());
	actprop->addRule(make_unique<RuleDoubleIn>("doubleprecis").release());
	actprop->addRule(make_unique<RuleDoubleOut>("doubleprecis").release());
	...
	conf->extra_pool_rules.clear(); // Rules are now absorbed into universal
      ...
      actstackstall->addAction(make_unique<ActionLaneDivide>("base").release());
      actstackstall->addAction(make_unique<ActionMultiCse>("analysis").release());
      actstackstall->addAction(make_unique<ActionShadowVar>("analysis").release());
      actstackstall->addAction(make_unique<ActionDeindirect>("deindirect").release());
      actstackstall->addAction(make_unique<ActionStackPtrFlow>("stackptrflow",stackspace).release());
      actmainloop->addAction( actstackstall );
      actmainloop->addAction(make_unique<ActionRedundBranch>("deadcontrolflow").release()); // dead code removal
      actmainloop->addAction(make_unique<ActionBlockStructure>("blockrecovery").release());
      actmainloop->addAction(make_unique<ActionConstantPtr>("typerecovery").release());
      {
	actprop2 = make_unique<ActionPool>(Action::rule_repeatapply,"oppool2").release();

	actprop2->addRule(make_unique<RulePushPtr>("typerecovery").release());
	actprop2->addRule(make_unique<RuleStructOffset0>("typerecovery").release());
	actprop2->addRule(make_unique<RulePtrArith>("typerecovery").release());
	//	actprop2->addRule(make_unique<RuleIndirectConcat>("analysis").release());
	actprop2->addRule(make_unique<RuleLoadVarnode>("stackvars").release());
	actprop2->addRule(make_unique<RuleStoreVarnode>("stackvars").release());
      }
      actmainloop->addAction( actprop2 );
      actmainloop->addAction(make_unique<ActionDeterminedBranch>("unreachable").release());
      actmainloop->addAction(make_unique<ActionUnreachable>("unreachable").release());
      actmainloop->addAction(make_unique<ActionNodeJoin>("nodejoin").release());
      actmainloop->addAction(make_unique<ActionConditionalExe>("conditionalexe").release());
      actmainloop->addAction(make_unique<ActionConditionalConst>("analysis").release());
    }
    actfullloop->addAction( actmainloop );
    actfullloop->addAction(make_unique<ActionLikelyTrash>("protorecovery").release());
    actfullloop->addAction(make_unique<ActionDirectWrite>("protorecovery_a", true).release());
    actfullloop->addAction(make_unique<ActionDirectWrite>("protorecovery_b", false).release());
    actfullloop->addAction(make_unique<ActionDeadCode>("deadcode").release());
    actfullloop->addAction(make_unique<ActionDoNothing>("deadcontrolflow").release());
    actfullloop->addAction(make_unique<ActionSwitchNorm>("switchnorm").release());
    actfullloop->addAction(make_unique<ActionReturnSplit>("returnsplit").release());
    actfullloop->addAction(make_unique<ActionUnjustifiedParams>("protorecovery").release());
    actfullloop->addAction(make_unique<ActionStartTypes>("typerecovery").release());
    actfullloop->addAction(make_unique<ActionActiveReturn>("protorecovery").release());
  }
  act->addAction( actfullloop );
  act->addAction(make_unique<ActionMappedLocalSync>("localrecovery").release());
  act->addAction(make_unique<ActionStartCleanUp>("cleanup").release());
  {
    actcleanup = make_unique<ActionPool>(Action::rule_repeatapply,"cleanup").release();

    actcleanup->addRule(make_unique<RuleMultNegOne>("cleanup").release());
    actcleanup->addRule(make_unique<RuleAddUnsigned>("cleanup").release());
    actcleanup->addRule(make_unique<Rule2Comp2Sub>("cleanup").release());
    actcleanup->addRule(make_unique<RuleDumptyHumpLate>("cleanup").release());
    actcleanup->addRule(make_unique<RuleSubRight>("cleanup").release());
    actcleanup->addRule(make_unique<RuleFloatSignCleanup>("cleanup").release());
    actcleanup->addRule(make_unique<RuleExpandLoad>("cleanup").release());
    actcleanup->addRule(make_unique<RulePtrsubCharConstant>("cleanup").release());
    actcleanup->addRule(make_unique<RuleExtensionPush>("cleanup").release());
    actcleanup->addRule(make_unique<RulePieceStructure>("cleanup").release());
    actcleanup->addRule(make_unique<RuleSplitCopy>("splitcopy").release());
    actcleanup->addRule(make_unique<RuleSplitLoad>("splitpointer").release());
    actcleanup->addRule(make_unique<RuleSplitStore>("splitpointer").release());
    ...
    actcleanup->addRule(make_unique<RuleBitFieldIn>("bitfields").release());
    actcleanup->addRule(make_unique<RulePullAbsorb>("bitfields").release());
    actcleanup->addRule(make_unique<RuleInsertAbsorb>("bitfields").release());
  }
  act->addAction( actcleanup );

  act->addAction(make_unique<ActionPreferComplement>("blockrecovery", true).release());
  act->addAction(make_unique<ActionStructureTransform>("blockrecovery", true).release());	// Allow mods
  act->addAction(make_unique<ActionNormalizeBranches>("normalizebranches").release());
  act->addAction(make_unique<ActionAssignHigh>("merge").release());
  act->addAction(make_unique<ActionMergeRequired>("merge").release());
  act->addAction(make_unique<ActionMarkExplicit>("merge").release());
  act->addAction(make_unique<ActionMarkImplied>("merge").release()); // This must come BEFORE general merging
  act->addAction(make_unique<ActionMergeMultiEntry>("merge").release());
  act->addAction(make_unique<ActionMergeCopy>("merge").release());
  act->addAction(make_unique<ActionDominantCopy>("merge").release());
  act->addAction(make_unique<ActionDynamicSymbols>("dynamic").release());
  act->addAction(make_unique<ActionMarkIndirectOnly>("merge").release()); // Must come after required merges but before speculative
  act->addAction(make_unique<ActionMergeAdjacent>("merge").release());
  act->addAction(make_unique<ActionMergeType>("merge").release());
  act->addAction(make_unique<ActionHideShadow>("merge").release());
  act->addAction(make_unique<ActionCopyMarker>("merge").release());
  act->addAction(make_unique<ActionLateDoNothing>("blockrecovery").release());
  act->addAction(make_unique<ActionBlockStructure>("blockrecovery").release());
  act->addAction(make_unique<ActionPreferComplement>("blockrecovery", false).release());		// Don't allow mods
  act->addAction(make_unique<ActionStructureTransform>("blockrecovery", false).release());	// Don't allow mods
  act->addAction(make_unique<ActionOutputPrototype>("localrecovery").release());
  act->addAction(make_unique<ActionInputPrototype>("fixateproto").release());
  act->addAction(make_unique<ActionMapGlobals>("fixateglobals").release());
  act->addAction(make_unique<ActionDynamicSymbols>("dynamic").release());
  act->addAction(make_unique<ActionNameVars>("merge").release());
  act->addAction(make_unique<ActionSetCasts>("casts").release());
  act->addAction(make_unique<ActionFinalStructure>("blockrecovery").release());
  act->addAction(make_unique<ActionPrototypeWarnings>("protorecovery").release());
  act->addAction(make_unique<ActionStop>("base").release());
}
