...
{
  glb = g;
  registerOption(make_unique<OptionExtraPop>().release());
  registerOption(make_unique<OptionReadOnly>().release());
  registerOption(make_unique<OptionIgnoreUnimplemented>().release());
  registerOption(make_unique<OptionErrorUnimplemented>().release());
  registerOption(make_unique<OptionErrorReinterpreted>().release());
  registerOption(make_unique<OptionErrorTooManyInstructions>().release());
  registerOption(make_unique<OptionDefaultPrototype>().release());
  registerOption(make_unique<OptionInferConstPtr>().release());
  registerOption(make_unique<OptionForLoops>().release());
  registerOption(make_unique<OptionInline>().release());
  registerOption(make_unique<OptionNoReturn>().release());
  registerOption(make_unique<OptionProtoEval>().release());
  registerOption(make_unique<OptionWarning>().release());
  registerOption(make_unique<OptionNullPrinting>().release());
  registerOption(make_unique<OptionInPlaceOps>().release());
  registerOption(make_unique<OptionConventionPrinting>().release());
  registerOption(make_unique<OptionNoCastPrinting>().release());
  registerOption(make_unique<OptionMaxLineWidth>().release());
  registerOption(make_unique<OptionIndentIncrement>().release());
  registerOption(make_unique<OptionCommentIndent>().release());
  registerOption(make_unique<OptionCommentStyle>().release());
  registerOption(make_unique<OptionCommentHeader>().release());
  registerOption(make_unique<OptionCommentInstruction>().release());
  registerOption(make_unique<OptionIntegerFormat>().release());
  registerOption(make_unique<OptionBraceFormat>().release());
  registerOption(make_unique<OptionCurrentAction>().release());
  registerOption(make_unique<OptionAllowContextSet>().release());
  registerOption(make_unique<OptionSetAction>().release());
  registerOption(make_unique<OptionSetLanguage>().release());
  registerOption(make_unique<OptionJumpTableMax>().release());
  registerOption(make_unique<OptionJumpLoad>().release());
