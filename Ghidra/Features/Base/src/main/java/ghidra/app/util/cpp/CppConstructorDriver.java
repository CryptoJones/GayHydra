...
public final class CppConstructorDriver {
	 ...
	 * immaterial). An argument that is neither named nor a boolean/char/enum/integer constant (an unnamed
	 * non-constant temporary, or a non-integer constant) declines the whole hint ({@code null}). Rendering
	 * compound expressions is later {@code #37-10} work. (Duplicated from the placement driver as an honest
