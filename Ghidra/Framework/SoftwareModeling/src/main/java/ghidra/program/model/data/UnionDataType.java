...
public class UnionDataType extends CompositeDataTypeImpl implements UnionInternal {
	 ...
	 * specified category path.  An empty union will report its length as 1 and 
	 ...
	 * within the specified category path.  An empty union will report its 
	...
	/**
	 * Construct a new empty union with the given name within the specified category path.
